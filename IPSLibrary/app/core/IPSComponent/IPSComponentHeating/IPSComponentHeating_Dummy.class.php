<?
    ...
    *
    * Definiert ein IPSComponentHeating_Dummy Object, das ein IPSComponentHeating Object für IPSenhancedFHZ implementiert.
    *
    * @author Günter Strassnigg
    * @version
    ...
    */
	...
	class IPSComponentHeating_Dummy extends IPSComponentHeating {
		 ...
		 * @param integer $instanceId2 InstanceId 2 des Dummy Devices (Richtungs Relais für den Fall das normale EIB Switches verwendet werden)

<?
	...
	define ('IPSLIGHT_TIMERCONFIG',			11);
	define ('IPSLIGHT_SWITCHONDELAY',		0);
	define ('IPSLIGHT_TIMER',					1);
	define ('IPSLIGHT_SWITCHOFFDELAY',		2);
	
	define ('IPSLIGHT_EDGE_CONTROLLED',		12);
	define ('IPSLIGHT_RISING_EDGE',			0);
	define ('IPSLIGHT_FALLING_EDGE',			1);
	define ('IPSLIGHT_BOTH_FLANKS',			2);
	define ('IPSLIGHT_EDGE_SENSORS',			3);

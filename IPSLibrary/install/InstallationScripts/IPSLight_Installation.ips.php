<?
	...
	CreateProfile_Switch ("IPSLight_Timer", 'Aus', 'An', $Icon="", -1, 255, $IconOff="BulbOff", $IconOn="BulbOn");
	CreateProfile_Switch ("IPSLight_OnDelayed", 'Aus', 'An', $Icon="", -1, 16750848, $IconOff="BulbOff", $IconOn="BulbOn");
	CreateProfile_Switch ("IPSLight_OffDelayed", 'Aus', 'An', $Icon="", 16750848, 65280, $IconOff="BulbOff", $IconOn="BulbOn");

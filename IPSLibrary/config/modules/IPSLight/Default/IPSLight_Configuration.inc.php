          ...
          return array(
            ...
            'Ambiente'  =>  array(
			   ...
			   'Garten'  =>  array(
			      ...
			      IPSLIGHT_GROUPS          => 'Aussenbereich,Alle',
			      IPSLIGHT_TYPE            => IPSLIGHT_TYPE_SWITCH,
			      IPSLIGHT_COMPONENT       => 'IPSComponentSwitch_EIB,10461',
			      IPSLIGHT_TIMERCONFIG		 => array(
								IPSLIGHT_TIMER			 => 15*60,
														 ),
					),
			   'Hofstiege'  =>  array(
			      IPSLIGHT_NAME            => 'Hofstiege',
			      IPSLIGHT_GROUPS          => 'Aussenbereich,Alle',
			      IPSLIGHT_TYPE            => IPSLIGHT_TYPE_SWITCH,
			      IPSLIGHT_COMPONENT       => 'IPSComponentSwitch_EIB,52082',
			      IPSLIGHT_TIMERCONFIG		 => array(
								IPSLIGHT_TIMER				 => 3*60,
								IPSLIGHT_EDGE_CONTROLLED => IPSLIGHT_RISING_EDGE,
								IPSLIGHT_EDGE_SENSORS	 => array(44778),
														 ),
					),
             );
        }
